...
var Checkin = io.vertx.workshop.data.Checkin;
...
var DataStorageService = function(j_val) {
  ...
  this.checkin = function(name, lat, lon, resultHandler) {
    ...
    if (__args.length === 4 && typeof __args[0] === 'string' && typeof __args[1] ==='number' && typeof __args[2] ==='number' && typeof __args[3] === 'function') {
      j_dataStorageService["checkin(java.lang.String,double,double,io.vertx.core.Handler)"](name, lat, lon, function(ar) {
      if (ar.succeeded()) {
  ...
  this.getCheckins = function(resultHandler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_dataStorageService["getCheckins(io.vertx.core.Handler)"](function(ar) {
      if (ar.succeeded()) {
